...
- CzechLight-specific YANG modules are added via [`czechlight-install-yang.service`](../package/cla-sysrepo/czechlight-install-yang.service),
...
- migrations to system configuration are applied via [`czechlight-migrate.service`](../package/czechlight-install-yang/czechlight-migrate.service),
