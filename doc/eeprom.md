...
| 3 | Variable | Optical calibration data (size is given in field no. 2). Structure is described [below](#optical-calibration-data). |
| 4 | 4 | CRC32 checksum spanning fields 0 to 3, the same CRC32 variant as ONIE's. |

### Optical calibration data (#optical-calibration-data)
