...
def test(sysrepo_fixture, max_version):
    ...
    run_and_wait(sysrepo_fixture, "JSON migration", [CFG_FS_SCRIPTS_PATH / "cfg-migrate.sh"])

    run_and_wait(sysrepo_fixture, "YANG modules setup and data installation to sysrepo", [CFG_FS_SCRIPTS_PATH / "cfg-yang.sh"])
