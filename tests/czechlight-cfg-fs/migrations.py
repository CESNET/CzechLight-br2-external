...
class SysrepoFixture:
    ...
    def get_env(self):
        ...
        res['SYSREPO_MODULE_DIR'] = pathlib.Path(os.environ['BASE_TARGET_DIR']) / 'usr' / 'share' / 'yang' / 'modules' / 'sysrepo'
        res['LN2_MODULE_DIR'] = pathlib.Path(os.environ['BASE_TARGET_DIR']) / 'usr' / 'share' / 'yang' / 'modules' / 'libnetconf2'
        res['NP2_MODULE_DIR'] = pathlib.Path(os.environ['BASE_TARGET_DIR']) / 'usr' / 'share' / 'yang' / 'modules' / 'netopeer2'
