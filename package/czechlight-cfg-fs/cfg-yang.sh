...
ROUSETTE_MODULES=(
    ...
    "--install ${ROUSETTE_YANG}/rousette@2026-08-07.yang"
        "--enable-feature configured-subscriptions-sse-proxy"
)
...
VELIA_MODULES=(
    "--install ${VELIA_YANG}/ietf-system@2014-08-06.yang"
        "--enable-feature ntp"
        "--enable-feature dns-udp-tcp-port"
...
CFG_FS_MODULES=(
    "--install ${CFG_FS_YANG}/czechlight-netconf-server@2026-05-18.yang"
)
CLA_MODULES=(
