...
endef
define CZECHLIGHT_GIT_UNSET_GITDIR_ENV
	unset GIT_DIR
endef
CLA_SYSREPO_POST_RSYNC_HOOKS += CZECHLIGHT_GIT_FIX_GITDIR
CLA_SYSREPO_PRE_CONFIGURE_HOOKS += CZECHLIGHT_GIT_UNSET_GITDIR_ENV
NETCONF_CLI_POST_RSYNC_HOOKS += CZECHLIGHT_GIT_FIX_GITDIR
NETCONF_CLI_PRE_CONFIGURE_HOOKS += CZECHLIGHT_GIT_UNSET_GITDIR_ENV
GAMMARUS_POST_RSYNC_HOOKS += CZECHLIGHT_GIT_FIX_GITDIR
GAMMARUS_PRE_CONFIGURE_HOOKS += CZECHLIGHT_GIT_UNSET_GITDIR_ENV
VELIA_POST_RSYNC_HOOKS += CZECHLIGHT_GIT_FIX_GITDIR
VELIA_PRE_CONFIGURE_HOOKS += CZECHLIGHT_GIT_UNSET_GITDIR_ENV
ROUSETTE_POST_RSYNC_HOOKS += CZECHLIGHT_GIT_FIX_GITDIR
ROUSETTE_PRE_CONFIGURE_HOOKS += CZECHLIGHT_GIT_UNSET_GITDIR_ENV
SYSREPO_IETF_ALARMS_POST_RSYNC_HOOKS += CZECHLIGHT_GIT_FIX_GITDIR
SYSREPO_IETF_ALARMS_PRE_CONFIGURE_HOOKS += CZECHLIGHT_GIT_UNSET_GITDIR_ENV
